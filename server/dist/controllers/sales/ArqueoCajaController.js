...
const ArqueoCajaService_1 = __importStar(require("../../services/sales/ArqueoCajaService"));
...
const ArqueoCajaController = {
    list: async (req, res) => {
        ...
        const arqueos = await ArqueoCajaService_1.default.list({ usuarioCodigo, aperturaCodigo });
        res.json({ arqueos });
    },
    available: async (req, res) => {
        ...
        try {
            const resumen = await ArqueoCajaService_1.default.obtenerResumenDisponible(usuarioCodigo, aperturaCodigo);
            res.json(resumen);
        }
        catch (error) {
    ...
    create: async (req, res) => {
        ...
        try {
            const arqueo = await ArqueoCajaService_1.default.create({
                aperturaCodigo,
                usuarioCodigo,
                motivo,
                detalles,
            ...
            if (error instanceof ArqueoCajaService_1.ArqueoAlreadyRegisteredError) {
                res.status(409).json({ message: error.message });
                return;
            }
            if (error instanceof ArqueoCajaService_1.ArqueoSaldoMismatchError) {
                res.status(400).json({
...
exports.default = ArqueoCajaController;
//# sourceMappingURL=ArqueoCajaController.js.map